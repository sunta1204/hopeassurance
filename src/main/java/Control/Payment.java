...
public class Payment {
	...
	public Payment(int payment_id, String payment_cartype,String payment_plate,String payment_username ,String payment_name ,String payment_email , String payment_phone ,
				String payment_address ,String payment_city ,String payment_country ,int payment_zipcode ,
				String payment_picName,String payment_proof,String payment_status,String transport_status , String payment_track ) {
		...
		this.payment_track = payment_track;
	}



	public String getPayment_track() {
		return payment_track;
	}



	public void setPayment_track(String payment_track) {
		this.payment_track = payment_track;
	}
