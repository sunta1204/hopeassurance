  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="dropdown-menu" id="dropdown-user">
		<button class="dropdown-item" data-toggle="modal" data-target="#showProfile">ดูข้อมูลส่วนตัว</button>
          ...
          <button class="dropdown-item" data-toggle="modal" data-target="#profilePic"> เพิ่มรูปภาพประจำตัว </button>
  							...
  							<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    							<div class="modal-content">
      								<div class="modal-header">
        								<h5 class="modal-title" style="font-size: 30px;">เพิ่มรูปประจำตัว</h5>
      								...
      								<div class="modal-body">
      									<div class="form-row">
      										<video id='video' width="640" height="480" style="margin-left: auto;margin-right: auto;"></video>
      									</div><br>
      									<div class="form-row">
      										<button type="button" id="snap" class="btn btn-outline-primary btn-block">CAPTURE</button>
      									</div>	<br>
      									<div class="form-row" style="margin-left: auto;margin-right: auto; width: 640px; height: 480 ;  ">
      										 <canvas id="canvas" width="640" height="480" style="margin-left: auto;margin-right: auto;"></canvas>
      									</div><br><br>
      									<div class="form-row">
      										<label class="text-primary" style="font-size: 20px;"> เลือกภาพประจำตัว </label>
      										<input type="file" name="member_picFile" id="canvas" class="form-control" accept="image/jpeg , image/png"> 									
      									</div>							   																										 
   										 <input type="hidden" name="member_pic" id="canvas" value="${memberProfile.member_username }">
   										 <input type="hidden" name="member_username" value="${memberProfile.member_username }">
						...
						<div class="modal fade " id="showProfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  							<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    							<div class="modal-content">
      								...
      								<div class="modal-body">
      									<div class="form-row">
      										<label class="text-primary" style="font-size: 20px; margin-left: auto; margin-right: auto;"> รูปประจำตัว : </label>
      									</div>
        								<div class="form-row">    										
      										<img  src="../memberPic/<%=(String)session.getAttribute("member_username") %>.jpg" style="width: 320px;height: 240px; ; margin-left: auto;margin-right: auto;">
        								</div><br>
        								<div class="form-row">
	...
	<!-- modal payonline -->
    <form action="/insertPaymentA" method="post"  enctype="multipart/form-data">
	...
	<!-- modal uploadProof -->
    <form action="/uploadProofA" method="post" enctype="multipart/form-data">
